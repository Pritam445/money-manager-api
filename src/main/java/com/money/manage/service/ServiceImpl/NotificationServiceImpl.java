...
import com.money.manage.service.NotificationService;
    ...
    public void sendDailyExpenseSummary() {
        ...
        for (ProfileEntity profile : profiles){
            ...
            if (!todaysExpenses.isEmpty()) {
                ...
                table.append("<tr style='background-color: #f2f2f2f;'><th style='border:1px solid #ddd;padding:8px;'>S.No</th><th style='border: 1px solid #ddd;padding: 8px;'>Name</th><th style='border: 1px solid #ddd;padding: 8px;'>Amount</th><th style='border: 1px solid #ddd;padding: 8px;'>Category</th><th style='border: 1px solid #ddd;padding: 8px;'>Date</th></tr>");
                int i = 1;
